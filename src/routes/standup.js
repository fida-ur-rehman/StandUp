...
router.get("/standupUser", isAuthorized, standupController.standupUser);
router.post("/org", isAuthorized, standupController.getOrgStandup);
...
router.post("/setAccess", isAuthorized, standupController.setAccess);
